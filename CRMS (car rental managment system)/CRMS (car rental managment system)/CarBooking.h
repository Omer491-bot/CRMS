...
namespace CRMS__car_rental_managment_system_ {
	...
	/// <summary>
	/// Summary for CarBooking
	/// </summary>
	public ref class CarBooking : public System::Windows::Forms::Form
	{
	public:
		CarBooking(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Click += gcnew System::EventHandler(this, &CarBooking::label2_Click);
			// 
			// label1
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei", 11, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(2, 305);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei", 11, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(26, 261);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei", 11, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(38, 217);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei", 11, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(77, 177);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei", 11, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(105, 135);
			...
			this->label9->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei", 11, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label9->Location = System::Drawing::Point(2, 346);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(193, 30);
			this->label9->TabIndex = 28;
			this->label9->Text = L"Dropoff Location";
			this->label9->Click += gcnew System::EventHandler(this, &CarBooking::label9_Click);
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(214, 351);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(214, 310);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(214, 266);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(214, 222);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(214, 177);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(214, 139);
			...
			this->button5->Font = (gcnew System::Drawing::Font(L"Microsoft Tai Le", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button5->Location = System::Drawing::Point(404, 139);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Tai Le", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(404, 222);
			...
			this->ClientSize = System::Drawing::Size(827, 450);
			...
			this->Name = L"CarBooking";
			this->Text = L"CarBooking";
			this->Load += gcnew System::EventHandler(this, &CarBooking::CarBooking_Load);
...
#pragma endregion
	private: System::Void CarBooking_Load(System::Object^ sender, System::EventArgs^ e) {
	}
